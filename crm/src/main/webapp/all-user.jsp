...
<div class="row">
    ...
    <div class="container">
        <h3 class="text-center">List of Users with there CRM</h3>
        <hr>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="user" items="${userList}">
                ...
                <tr>
                    ...
                    <td><a href="changeCrm?id=<c:out value='${user.id}' />">ChangeCrm</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="editUser?id=<c:out value='${user.id}' />">EditUser</a>
                    </td>
                </tr>
